    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <nav class="nav flex-column">
                ...
                <a href="StudentListServlet" class="nav-link"><i class="bi bi-people-fill me-2"></i> Student</a>
                <a href="SupervisorMilestoneServlet" class="nav-link active"><i class="bi bi-list-check me-2"></i> Track Milestone</a>
