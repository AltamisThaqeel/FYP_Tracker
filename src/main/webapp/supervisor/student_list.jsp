    ...
    <body>
        ...
        <div class="main-content">
            ...
            <div class="row row-cols-1 row-cols-md-2 g-4">
                ...
                %>
                <div class="col">
                    <div class="project-card" onclick="location.href = 'SupervisorMilestoneServlet?studentId=<%= p.getStudentId() %>&projectId=<%= p.getProjectId() %>'">
                        ...
                        <div class="student-id">
                            ID: <%= p.getStudentId() %> | <%= (p.getContactPhone()!=null) ? p.getContactPhone() : "-" %>
                        </div>
                    </div>
                </div>
                <%      }
                ...
                %>
                <div class="col-12"><p class="text-muted">No projects assigned yet.</p></div>
                <% } %>
            </div>
        </div>
