    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <nav>
                ...
                <a href="${pageContext.request.contextPath}/AdminAssignServlet" class="nav-link active"><i class="bi bi-person-lines-fill me-2"></i> Assign Student</a>
                <a href="${pageContext.request.contextPath}/AdminUsersServlet" class="nav-link"><i class="bi bi-people-fill me-2"></i> Manage Account</a>
